...
//         <Image src="/placeholder.svg" alt="AI Fashion Hero" fill className="object-cover brightness-50" />
...
//           <Image src="/placeholder.svg" alt="Upcoming Trends" fill className="rounded-lg object-cover" />
//         </div>
//       </section>
...
//           <Image src="/placeholder.svg" alt="Design Direction" fill className="rounded-lg object-cover" />
//         </div>
//         <div className="space-y-4">
...
//         </div>
//         <div className="relative h-[500px]">
//           <Image src="/placeholder.svg" alt="Virtual Try-On" fill className="rounded-lg object-cover" />
//         </div>
//       </section>
...
//       <section className="mx-auto grid max-w-7xl gap-8 px-4 py-16 md:grid-cols-2">
//         <div className="relative h-[500px]">
//           <Image src="/placeholder.svg" alt="Recommendation System" fill className="rounded-lg object-cover" />
//         </div>
//         <div className="space-y-4">
...
//               <Image src="/placeholder.svg" alt="AI Analytics" fill className="rounded-lg object-cover" />
//             </div>
//           </div>
//         </div>
//       </section>
...
//               <div className="relative h-[400px]">
//                 <Image src="/placeholder.svg" alt="Trend 1" fill className="rounded-lg object-cover" />
//               </div>
//               <div className="relative h-[400px]">
//                 <Image src="/placeholder.svg" alt="Trend 2" fill className="rounded-lg object-cover" />
//               </div>
//             </div>
//           </div>
//         </div>
...
//         <Image src="/placeholder.svg" alt="Final CTA" fill className="object-cover brightness-50" />
//         <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
